                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                              {{ __('MENU DE ADMINISTRADOR ( IMAGENES A EDITAR )') }}
                            </span>
                            <div class="float-right">
                                <a href="{{ route('perfiles.index') }}" class="btn btn-info btn-sm float-right"  data-placement="left">
                                  {{ __('Listar Perfiles') }}
                                </a>
                              
                                <a href="{{ route('cuentas.index') }}" class="btn btn-success btn-sm float-right"  data-placement="left">
                                  {{ __('Listar Cuentas') }}
                                </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('imagenes.destroy',$imagene->id) }}" method="POST">
                                                    ...
                                                    <a class="btn btn-sm btn-success" href="{{ route('imagenes.edit',$imagene->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Editar') }}</a>
                                                    @csrf
                                                    @method('DELETE')
